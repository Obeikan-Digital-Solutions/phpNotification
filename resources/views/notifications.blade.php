 <div class="dropdown notifications">
                    <button type="button" aria-haspopup="true" aria-expanded="false"
                        ...
                        <span class="icon-wrapper icon-wrapper-alt rounded-circle">
                            ...
                            <span class="badge badge-dot badge-dot-sm badge-danger count-notifications">{{ count(auth()->user()->unreadNotifications) }}</span>
                            @endif
                        </span>
                    </button>
                    ...
                    <div tabindex="-1" role="menu" aria-hidden="true"
                            ...
                            <div class="dropdown-menu-header-inner py-2">
                                <div class="menu-header-content btn-pane-right text-dark">
                                    ...
                                    <div class="menu-header-btn-pane">
                                        <button type="button" id="mark-all" aria-haspopup="true" data-toggle="{{ count(auth()->user()->unreadNotifications) ? 'tooltip' : '' }}" data-placement="left"
                                            title="{{ __('app.Mark all as read') }}" aria-expanded="false" class="p-0 btn dd-chart-btn"
                                        ...
                                        <div class="widget-content p-0">
                                            <div class="widget-content-wrapper">
                                                ...
                                                <div class="widget-content-left mr-3">
                                                    <div class="icon-wrapper border-light rounded-circle justify-content-center">
                                                        ...
                                                        <svg width="30" fill="#0071C1" viewBox="0 0 57.84 43.01">
                                                            <path d="M3.44,33.85A1.84,1.84,0,1,0,.25,35.7l3.69,6.39a1.85,1.85,0,0,0,3.2-1.85Z"></path>
                                                            <path d="M48.39,28.08,44.27,21l-5.54-9.58L34.61,4.24a1.22,1.22,0,0,0-1.68-.42,1.28,1.28,0,0,0-.22.17l-28,27,5.54,9.58,7-2L20.35,42a1.89,1.89,0,0,0,1.84.56l9.29-2.64c.12-.07.3-.13.43-.19a1.77,1.77,0,0,0,.86-1.23L33.63,34l14.08-4a1.34,1.34,0,0,0,.75-1.74.8.8,0,0,0-.08-.16Zm-18,9.52-8.54,2.46-2-2.21L31,34.65Z"></path>
                                                            <rect x="47.8" y="8.49" width="8.49" height="2.97" transform="translate(1.79 26.79) rotate(-29.35)"></rect>
                                                            <rect x="51.87" y="14.25" width="2.97" height="8.49" transform="translate(21.15 64.88) rotate(-74.35)"></rect>
                                                            <rect x="41.14" y="3" width="8.48" height="2.97" transform="translate(28.82 46.97) rotate(-74.34)"></rect>
                                                        </svg>
                                                        @endif
                                                        @if ($check_activity)
                                                        <svg width="30" fill="#0071C1" viewBox="0 0 59.04 55.49">
                                                            <path d="M38.94,36.21A1.27,1.27,0,0,0,36.71,35l-2.54,4.52,1.71-6.81a1.27,1.27,0,1,0-2.48-.57L31.94,38V31.63a1.28,1.28,0,0,0-2.55,0v6.81l-1.46-6.3a1.28,1.28,0,0,0-1.53-1,1.26,1.26,0,0,0-.95,1.53l1.78,7.57a14.87,14.87,0,0,1-.44,2.55.06.06,0,0,0-.07-.06,8.57,8.57,0,0,0-4.45-3.57,1.19,1.19,0,1,0-.64,2.29c.83.19,1.59,1.4,2.42,2.68a12.85,12.85,0,0,0,4.2,4.51v6.81h5.6V48.3C36,47.22,36.2,42.7,36.27,41l2.67-4.77Z"></path>
                                                ...
                                                <div class="widget-content-right d-flex flex-column align-items-center">
                                                    ...
                                                    <button type="button" class="btn mb-2 badge badge-dot badge-primary mark-as-read"
                                                        data-id="{{ $notification->id }}" data-toggle="tooltip" data-placement="top"
                        ...
                        <div class="px-3 py-2">
                            <a href="javascript:void(0)" class="btn-block border-0 btn btn-light btn-sm">{{ __('app.Show all notifications') }}</a>
                        </div>
                    </div>
                </div>
